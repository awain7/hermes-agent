...
# ``profile`` (fork): multiplex gateway profile this turn runs under (e.g. "travel"); None for
# the default/active profile and for non-gateway frontends. Embedded in the system prompt
# (agent/system_prompt.py) and checked by conversation_loop._stored_prompt_matches_runtime() so
# a session's cached system prompt is never reused across a profile change.
_PASSTHROUGH_PARAMS = (
    "model", "max_iterations", "save_trajectories", "verbose_logging", "quiet_mode",
    "tool_progress_mode", "ephemeral_system_prompt", "platform", "profile", "skip_context_files",
...
def init_agent(
    ...
    platform: str = None, profile: str = None, user_id: str = None, user_id_alt: str = None,
    user_name: str = None,
